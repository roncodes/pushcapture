...
@SuppressLint("NewApi")
public class CopyOfPushCaptureActivity extends Activity implements SurfaceHolder.Callback {
	...
	private void initPreview(int width, int height) {
	    if (mCamera!=null && mHolder.getSurface()!=null) {
	      try {
	        ...
	        Toast
	          .makeText(CopyOfPushCaptureActivity.this, t.getMessage(), Toast.LENGTH_LONG)
	          .show();
	      }
